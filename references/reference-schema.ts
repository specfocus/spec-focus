import { getter } from '../objects/property-expr';
import type { SchemaRefDescription } from '../schemas/description';
...
export class ReferenceSet {
  ...
  describe() {
    const description = [] as (unknown | SchemaRefDescription)[];
...
// @ts-ignore
Reference.prototype.__isRef = true;
